...
import io.pnyx.zoe.bytes.intToBigEndian
...
class SHA256Digest {
    ...
    private fun processWord(
        ...
        var n = input[inOff].toInt() shl 24
        n = n or (input[++inOff].toInt() and 0xff shl 16)
        n = n or (input[++inOff].toInt() and 0xff shl 8)
        n = n or (input[++inOff].toInt() and 0xff)
        X[xOff] = n
