...
import io.pnyx.keddsa.math.ed22519.Ed25519LittleEndianEncoding.Companion.load_3
import io.pnyx.keddsa.math.ed22519.Ed25519LittleEndianEncoding.Companion.load_4
...
class Ed25519ScalarOps : ScalarOps {
    ...
    override fun reduce(s: ByteArray): ByteArray {
        ...
        var s0 = 0x1FFFFFL and load_3(s, 0).toLong()
        var s1 = 0x1FFFFFL and (load_4(s, 2) shr 5)
        var s2 = 0x1FFFFFL and (load_3(s, 5) shr 2).toLong()
        var s3 = 0x1FFFFFL and (load_4(s, 7) shr 7)
        var s4 = 0x1FFFFFL and (load_4(s, 10) shr 4)
        var s5 = 0x1FFFFFL and (load_3(s, 13) shr 1).toLong()
        var s6 = 0x1FFFFFL and (load_4(s, 15) shr 6)
        var s7 = 0x1FFFFFL and (load_3(s, 18) shr 3).toLong()
        var s8 = 0x1FFFFFL and load_3(s, 21).toLong()
        var s9 = 0x1FFFFFL and (load_4(s, 23) shr 5)
        var s10 = 0x1FFFFFL and (load_3(s, 26) shr 2).toLong()
        var s11 = 0x1FFFFFL and (load_4(s, 28) shr 7)
        var s12 = 0x1FFFFFL and (load_4(s, 31) shr 4)
        var s13 = 0x1FFFFFL and (load_3(s, 34) shr 1).toLong()
        var s14 = 0x1FFFFFL and (load_4(s, 36) shr 6)
        var s15 = 0x1FFFFFL and (load_3(s, 39) shr 3).toLong()
        var s16 = 0x1FFFFFL and load_3(s, 42).toLong()
        var s17 = 0x1FFFFFL and (load_4(s, 44) shr 5)
        val s18 = 0x1FFFFFL and (load_3(s, 47) shr 2).toLong()
        val s19 = 0x1FFFFFL and (load_4(s, 49) shr 7)
        val s20 = 0x1FFFFFL and (load_4(s, 52) shr 4)
        val s21 = 0x1FFFFFL and (load_3(s, 55) shr 1).toLong()
    ...
    override fun multiplyAndAdd(a: ByteArray, b: ByteArray, c: ByteArray): ByteArray {
        val a0 = 0x1FFFFFL and load_3(a, 0).toLong()
        val a1 = 0x1FFFFFL and (load_4(a, 2) shr 5)
        val a2 = 0x1FFFFFL and (load_3(a, 5) shr 2).toLong()
        val a3 = 0x1FFFFFL and (load_4(a, 7) shr 7)
        val a4 = 0x1FFFFFL and (load_4(a, 10) shr 4)
        val a5 = 0x1FFFFFL and (load_3(a, 13) shr 1).toLong()
        val a6 = 0x1FFFFFL and (load_4(a, 15) shr 6)
        val a7 = 0x1FFFFFL and (load_3(a, 18) shr 3).toLong()
        val a8 = 0x1FFFFFL and load_3(a, 21).toLong()
        val a9 = 0x1FFFFFL and (load_4(a, 23) shr 5)
        val a10 = 0x1FFFFFL and (load_3(a, 26) shr 2).toLong()
        val a11 = load_4(a, 28) shr 7
        val b0 = 0x1FFFFFL and load_3(b, 0).toLong()
        val b1 = 0x1FFFFFL and (load_4(b, 2) shr 5)
        val b2 = 0x1FFFFFL and (load_3(b, 5) shr 2).toLong()
        val b3 = 0x1FFFFFL and (load_4(b, 7) shr 7)
        val b4 = 0x1FFFFFL and (load_4(b, 10) shr 4)
        val b5 = 0x1FFFFFL and (load_3(b, 13) shr 1).toLong()
        val b6 = 0x1FFFFFL and (load_4(b, 15) shr 6)
        val b7 = 0x1FFFFFL and (load_3(b, 18) shr 3).toLong()
        val b8 = 0x1FFFFFL and load_3(b, 21).toLong()
        val b9 = 0x1FFFFFL and (load_4(b, 23) shr 5)
        val b10 = 0x1FFFFFL and (load_3(b, 26) shr 2).toLong()
        val b11 = load_4(b, 28) shr 7
        val c0 = 0x1FFFFFL and load_3(c, 0).toLong()
        val c1 = 0x1FFFFFL and (load_4(c, 2) shr 5)
        val c2 = 0x1FFFFFL and (load_3(c, 5) shr 2).toLong()
        val c3 = 0x1FFFFFL and (load_4(c, 7) shr 7)
        val c4 = 0x1FFFFFL and (load_4(c, 10) shr 4)
        val c5 = 0x1FFFFFL and (load_3(c, 13) shr 1).toLong()
        val c6 = 0x1FFFFFL and (load_4(c, 15) shr 6)
        val c7 = 0x1FFFFFL and (load_3(c, 18) shr 3).toLong()
        val c8 = 0x1FFFFFL and load_3(c, 21).toLong()
        val c9 = 0x1FFFFFL and (load_4(c, 23) shr 5)
        val c10 = 0x1FFFFFL and (load_3(c, 26) shr 2).toLong()
